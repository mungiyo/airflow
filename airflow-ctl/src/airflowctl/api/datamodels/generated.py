...
class Value(RootModel[tuple[str, str]]):
    root: Annotated[tuple[str, str], Field(max_length=2, min_length=2, title="Value")]
...
class EventLogResponse(BaseModel):
    ...
    owner_display_name: Annotated[str | None, Field(title="Owner Display Name")]
    extra: Annotated[str | None, Field(title="Extra")]
...
class JobResponse(BaseModel):
    ...
    start_date: Annotated[datetime | None, Field(title="Start Date")]
    end_date: Annotated[datetime | None, Field(title="End Date")]
    latest_heartbeat: Annotated[datetime | None, Field(title="Latest Heartbeat")]
...
class TaskInstancesLogResponse(BaseModel):
    ...
    continuation_token: Annotated[str | None, Field(title="Continuation Token")]
...
class TaskStateStoreBody(BaseModel):
    ...
    value: JsonValue
    expires_at: Annotated[datetime | Literal["default"] | None, Field(title="Expires At")] = "default"
...
class DAGResponse(BaseModel):
    ...
    next_dagrun_logical_date: Annotated[datetime | None, Field(title="Next Dagrun Logical Date")]
    next_dagrun_data_interval_start: Annotated[
        datetime | None, Field(title="Next Dagrun Data Interval Start")
    ]
    next_dagrun_data_interval_end: Annotated[datetime | None, Field(title="Next Dagrun Data Interval End")]
...
class DAGRunResponse(BaseModel):
    ...
    data_interval_end: Annotated[datetime | None, Field(title="Data Interval End")]
    run_after: Annotated[datetime, Field(title="Run After")]
    last_scheduling_decision: Annotated[datetime | None, Field(title="Last Scheduling Decision")]
    run_type: DagRunType
    state: DagRunState
    triggered_by: DagRunTriggeredByType | None
    triggering_user_name: Annotated[str | None, Field(title="Triggering User Name")]
...
class PluginResponse(BaseModel):
    ...
    appbuilder_menu_items: Annotated[
        list[AppBuilderMenuItemResponse], Field(deprecated=True, title="Appbuilder Menu Items")
    ]
...
class TaskInstanceResponse(BaseModel):
    ...
    executor_config: Annotated[str, Field(title="Executor Config")]
    note: Annotated[str | None, Field(title="Note")]
    rendered_map_index: Annotated[str | None, Field(title="Rendered Map Index")]
...
class TaskResponse(BaseModel):
    ...
    template_fields: Annotated[list[str] | None, Field(title="Template Fields")]
    downstream_task_ids: Annotated[list[str] | None, Field(title="Downstream Task Ids")]
